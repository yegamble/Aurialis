/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61b95546f2a2579523bea0e456b72900)
// Runtime types generated with workerd@1.20260424.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "BackendContainer" | "RateLimitDO" | "GlobalRateLimitDO";
	}
	interface Env {
		UPLOADS: R2Bucket;
		...
		BACKEND: DurableObjectNamespace<import("./src/worker").BackendContainer>;
		RATE_LIMIT_PER_IP: DurableObjectNamespace<import("./src/worker").RateLimitDO>;
		RATE_LIMIT_GLOBAL: DurableObjectNamespace<import("./src/worker").GlobalRateLimitDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPLOADS_BUCKET_NAME" | "RATE_LIMIT_PER_HOUR" | "GLOBAL_RATE_LIMIT_PER_HOUR" | "MAX_UPLOAD_BYTES" | "CHUNK_SIZE_BYTES" | "PART_PRESIGN_EXPIRY_SECONDS" | "GET_PRESIGN_EXPIRY_SECONDS" | "ALLOWED_ORIGINS" | "TURNSTILE_SITE_KEY_PUBLIC">> {}
}
