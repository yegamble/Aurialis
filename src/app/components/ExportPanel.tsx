  ...
  return (
    <div className="rounded-2xl bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.06)] p-5 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <SelectField label="Sample Rate" value={sampleRate} onChange={setSampleRate} options={["44.1 kHz", "48 kHz", "96 kHz"]} />
        <SelectField label="Bit Depth" value={bitDepth} onChange={setBitDepth} options={["16-bit", "24-bit", "32-bit float"]} />
        <SelectField label="Dither" value={dither} onChange={setDither} options={["None", "TPDF", "Noise Shaped"]} />
      </div>
