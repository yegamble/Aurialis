...
export function MixToolbar({
  ...
  return (
    <div
      ...
      className="sticky top-0 z-40 flex items-center justify-between gap-2 border-b border-[rgba(255,255,255,0.06)] bg-[rgba(20,20,22,0.8)] px-3 py-3 backdrop-blur-xl sm:gap-4 sm:px-5"
    >
      ...
      {hasStemsLoaded ? (
        <div className="flex min-w-0 items-center gap-2">
          <button
            ...
            className={
              "flex items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs transition-colors sm:px-3 " +
              (smartRepairEnabled
          ...
          >
            ...
            <span className="hidden sm:inline">Smart Repair</span>
          </button>
          <button
            type="button"
            ...
            aria-label={autoMixLabel}
            className="flex items-center gap-1.5 rounded-lg bg-[rgba(255,255,255,0.06)] px-2.5 py-1.5 text-xs text-[rgba(255,255,255,0.7)] transition-colors hover:bg-[rgba(255,255,255,0.1)] hover:text-white disabled:opacity-40 sm:px-3"
          >
            <Sparkles className="h-3.5 w-3.5 shrink-0" />
            <span className="hidden sm:inline">{autoMixLabel}</span>
          </button>
          <button
            type="button"
            ...
            className="flex items-center gap-1.5 rounded-lg bg-[#0a84ff]/20 px-2.5 py-1.5 text-xs text-[#0a84ff] transition-colors hover:bg-[#0a84ff]/30 disabled:opacity-40 sm:px-3"
          >
